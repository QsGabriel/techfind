...
<section class="flex items-center justify-center gap-40 py-8">
	<div id="cta" class="flex w-full flex-col items-center gap-8 xl:w-1/3 xl:items-stretch">
		...
		<p class="size-8 w-fit text-center">
			A TechFind te conecta com os melhores serviços de forma rápida e fácil.
		</p>
	...
	<div id="banner" class="hidden xl:flex">
		<img src={banner} width="700px" alt="logo da empresa TechFind" />
	</div>
</section>
