...
exemplo: texto de usuário: gostaria de profissionais que de tecnologia para a criação de um site pessoal. profile 1: - id: 1; - id_auth: 1; - name: jubileu; - type: 1; - type_personal: 99999999999; - phone: 99999999999; - date: 2025-10-12; - description: "sou um profissional apaixonado por tecnologia."; - caract: "profissional de tecnologia."; - tags: "frontend-backend-fullstack-postgreSQL"; profile 2: - id: 2; - id_auth: 2; - name: ana; - type: 1; - type_personal: 99999999999; - phone: 99999999999; - date: 2025-10-12; - description: "sou uma profissional da área de Banco de dados."; - caract: "profissional de Banco de Dados."; - tags: "Banco de dados-backend-postgreSQL"; resposta: baseado na sua descrição, você necessita de profissionais na área de desenvolvimento web (frontend - tela, backend - banco de dados, métodos ágeis - para a coordenação e gerência) para a sua necessidade, os melhores profissionais área de tecnologia são: **1 profissional de banco de dados**; **3 profissionais fullstack**; **1 profissional de métodos ágeis**; Esses profissionais podem ser encontrados com as seguintes tags: Desenvolvimento de Software Testes de Software-Pentesting-Criptografia-Segurança da Informação-Qualidade de Software- `;
		...
		let description = text.split('Esses profissionais podem ser encontrados com as seguintes tags:')[0];
		description =
		...
		cookies.set('api', JSON.stringify({ usuarios: usuarios, description: description, tags: tags }), {
			path: './pesquisa',
			maxAge: 60 * 60 * 24 // 24 hours
		});
		return {
