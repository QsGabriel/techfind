...
<div class="min-h-screen p-4 sm:p-6 lg:p-8">
	...
	<div class="mb-8 text-center" in:fade={{ duration: 300 }}>
		...
		<h1 class="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-3">Criar Novo Contrato</h1>
		<p class="text-base sm:text-lg text-gray-600 dark:text-gray-400">Preencha os detalhes do contrato profissional</p>
	</div>
